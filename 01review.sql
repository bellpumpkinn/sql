...
from departments;  -- 특정칼럼만 받고싶을때 select from을 쓴다.

select location_id, department_id
from departments;  -- 내 맘대로 칼럼순서 바꾸기 가능

desc departments --departments의 구조를 확인.  desc는 구조를 확인.

--과제] employees의 구조를 확인하라.
desc employees
...
from employees; --커미션 안받는애들은 연봉이 안뜬다. null이 있어서 그럼
...
from employees;   -- 숫자가 문자가 되서 문자로 붙음
select last_name || salary
from employees;   -- 숫자가 문자 24000이 되서 문자 King24000이 됨.
